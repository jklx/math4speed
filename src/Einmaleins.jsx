...
export default function Einmaleins({ a, b, value = '', onChange, onEnter, showTick = false, crossedOut = false, mistakeFeedback = null, readOnly = false }) {
    ...
    <div className="question-centered">
      <div className="einmaleins-row">
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
          ...
          >
            {value}
            {!readOnly && !mistakeFeedback && focused && <span className="fake-input__cursor" aria-hidden />}
          </div>
